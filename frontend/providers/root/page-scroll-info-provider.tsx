...
export function PageScrollInfoProvider({ children }: PropsWithChildren) {
  return (
    <>
      <ScrollDetector />
      {children}
    ...
    const scrollHandler = throttle(
      () => {
        ...
        setPageScrollDirection(
          prevScrollY.current > currentTop ? 'up' : 'down'
        );
...
const usePageScrollLocationSelector = createAtomSelector(
